      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-charcoal/70 text-base leading-relaxed">
            Heritage Bay Plumbing Inc. is a licensed, insured, and bonded union plumbing construction company founded by Jared Murray and Anthony Macri. While the Heritage Bay name is new, the experience behind it is not. With over 30 years of UA union-trained expertise, Jared, Anthony, and their team pair an old-school work ethic with new-school technology on every commercial, multi-family, and industrial project they take on. Heritage Bay is a proud UA Signatory Contractor affiliated with UA Plumbing Local 403 out of San Luis Obispo, CA, meaning every project is completed to the highest union standards in the industry. Serving clients from Santa Cruz to Calabasas, Heritage Bay is built for the scale and complexity of commercial plumbing construction.
          </p>
        </div>
      </div>
    </section>
